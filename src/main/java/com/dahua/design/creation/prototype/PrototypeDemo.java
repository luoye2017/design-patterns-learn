...
public class PrototypeDemo {
    ...
    public static void main(String[] args) throws Exception {
        MyBatisCache cache = new MyBatisCache();

        //十分危险
        //得到的是克隆体
        User zhangsan1 = cache.selectUser("zhangsan");
        System.out.println("1==>"+zhangsan1);
        zhangsan1.setName("李四2.。。");
        System.out.println("zhangsan1自己改了："+zhangsan1);

        //得到的是克隆体
        User zhangsan2 = cache.selectUser("zhangsan");
        System.out.println("2-->"+zhangsan2);

        //得到的是克隆体
        User zhangsan3 = cache.selectUser("zhangsan");
        System.out.println("3-->"+zhangsan3);

        //得到的是克隆体
        User zhangsan4 = cache.selectUser("zhangsan");
